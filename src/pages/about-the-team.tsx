...
const AboutTheTeam = () => (
  <Layout>
    ...
    <Accordion defaultIndex={[0]} allowToggle allowMultiple style={{ borderStyle: "none" }}> 
      <TeamCards people={leadTeam} team="Team Leads" />
      <TeamCards people={techTeam} team="Tech Team" />
      <TeamCards people={eventTeam} team="Event Team" />
      <TeamCards people={outreachTeam} team="Outreach Team" />
    </Accordion>
  </Layout>
);
